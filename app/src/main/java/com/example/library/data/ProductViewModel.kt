...
import com.example.library.network.ImgurApiService
...
class ProductViewModel : ViewModel() {
    ...
    fun updateProduct(context: Context,navController: NavController,
                      ...
                      productprice: String,productbrand: String,desc: String,productId: String){
        val databaseReference = FirebaseDatabase.getInstance()
            .getReference("Products/$productId")
        val updatedClient = ProductModel(productname, productquantity,
            productprice,productbrand, desc,"",productId)
