...
fun RegisterScreen(navController: NavController){
    ...
    var middlename by remember { mutableStateOf(value = "") }
    ...
    Column (modifier = Modifier.fillMaxSize()
        ...
        Spacer(modifier = Modifier.height(10.dp))
        OutlinedTextField(value = middlename,
            onValueChange = {newmiddleName ->middlename = newmiddleName},
            label = {Text(text = "Enter middle Name" )},
            placeholder = {Text(text = "Please enter middlename")},
            modifier = Modifier.wrapContentWidth().align(Alignment.CenterHorizontally),
            shape = RoundedCornerShape(16.dp),
            leadingIcon = { Icon(imageVector = Icons.Default.Person,
                contentDescription = "Person icon") })
        ...
        Spacer(modifier = Modifier.height(10.dp))
        Button(onClick = {
            authViewModel.signup(firstname,middlename,lastname,email,password,navController,context)
        },
